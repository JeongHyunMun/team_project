...
<div align="center">
	...
	<form>
		<table id="join_table" border="1" >
			...
			<tr>
				<td><p id="p_tag">이름</p><input class="input" id="nickname" type="text" name="name" required="required" placeholder="이름을 입력하시오"></td>
			</tr>
			<tr>
			...
			<tr>
				<td><p id="p_tag">이메일주소</p><input class="input" id="email" type="text" name="email" maxlength="30" placeholder="이메일의 형식은 ****@****.*** 입니다."/></td>
			</tr>
			<tr>
				<td><p id="p_tag">핸드폰번호</p>
				<input class="input" id="input_tel" type="text" name="phone" required="required" placeholder="핸드폰 번호를 입력하시오"></td>
